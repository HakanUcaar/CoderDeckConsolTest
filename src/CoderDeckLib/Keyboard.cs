...
namespace CoderDeckLib
{
    static class Keyboard
    {
        ...
        public static void KeyStroke(bool ctrl = false, bool alt = false, bool shift = false, params char[] KeyList)
        {
            List<ushort> keys = new List<ushort>();
        ...
        public static void CtrlKeyStroke(params char[] KeyList)
        {
            List<ushort> keys = new List<ushort>();
        ...
        public static void AltKeyStroke(params char[] KeyList)
        {
            List<ushort> keys = new List<ushort>();
        ...
        public static void ShiftKeyStroke(params char[] KeyList)
        {
            List<ushort> keys = new List<ushort>();
